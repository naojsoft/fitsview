#! /usr/bin/env python
#
# guideview.py -- Customized Ginga viewer for Gen2 guider operation.
#
import sys
import os
...
# ugly hack to make this look decent with Gtk widgets in a non-gnome
# environment
os.environ['GTK_THEME'] = 'Greybird'
